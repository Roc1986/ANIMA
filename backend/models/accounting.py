...
def get_default_accounts():
    return [
        ...
        {"code": "2-01-008", "name": "Mutual ISL por Pagar", "account_type": "pasivo"},
        {"code": "2-01-009", "name": "Seguro Social Ley 21.735 por Pagar", "account_type": "pasivo"},
        {"code": "2-01-010", "name": "Reforma AFP Empleador por Pagar", "account_type": "pasivo"},
        {"code": "2-01-011", "name": "Otros Descuentos por Pagar", "account_type": "pasivo"},
