...
const CARD_IMAGES: Record<string, any> = {
  ...
  'los-amantes': require('../../assets/cards/los-amantes.png'),
  'el-carro': require('../../assets/cards/el-carro.png'),
  'fuerza': require('../../assets/cards/fuerza.png'),
  'el-ermitano': require('../../assets/cards/el-ermitano.png'),
  'rueda-de-la-fortuna': require('../../assets/cards/rueda-de-la-fortuna.png'),
  'justicia': require('../../assets/cards/justicia.png'),
  'el-colgado': require('../../assets/cards/el-colgado.png'),
  'muerte': require('../../assets/cards/muerte.png'),
  'templanza': require('../../assets/cards/templanza.png'),
  ...
  'juicio': require('../../assets/cards/juicio.png'),
