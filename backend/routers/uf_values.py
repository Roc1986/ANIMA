...
def seed_uf_values(db: Session = Depends(get_db), current_user: User = Depends(require_admin)):
    ...
    values = [
        ...
        # 2025 fin de mes — ESTIMADOS, verificar en cmfchile.cl
        ("2025-01-31", 38974.04), ("2025-02-28", 39117.96), ("2025-03-31", 39200.00),
        ("2025-04-30", 39350.00), ("2025-05-31", 39450.00), ("2025-06-30", 39500.00),
        ("2025-07-31", 39550.00), ("2025-08-31", 39600.00), ("2025-09-30", 39620.00),
        ("2025-10-31", 39640.00), ("2025-11-30", 39660.00), ("2025-12-31", 39680.00),
        # 2026 fin de mes — Fuente: CMF Chile (confirmados por usuario)
        ("2026-01-31", 39706.07), ("2026-02-28", 39774.00), ("2026-03-31", 39841.72),
        ("2026-04-30", 40200.00), ("2026-05-31", 40610.69), ("2026-06-30", 40820.31),
    ]
    count = 0
    for d, v in values:
